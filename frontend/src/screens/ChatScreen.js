...
useEffect(() => {
  ...
  useEffect(() => {
    if (!socket || !isForgeReady || !userId || !auth.privateKey) return () => {};
  ...
  }, [socket, isForgeReady, selectedChat, userId, chats, dispatch, unreadMessages, auth.privateKey, decryptMessage]);
